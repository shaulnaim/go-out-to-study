...
/******/ 	return __webpack_require__(__webpack_require__.s = "./shioors-read-all.js");
/******/ })
/************************************************************************/
/******/ ({
...
var request = __webpack_require__(/*! superagent */ "../node_modules/superagent/lib/node/index.js");
...
const mime = __webpack_require__(/*! mime */ "../node_modules/superagent/node_modules/mime/mime.js");
...
mime.define(__webpack_require__(/*! ./types.json */ "../node_modules/superagent/node_modules/mime/types.json"));
...
exports.handler = (event, context, callback) => {
  ...
  return client.query(q.Paginate(q.Match(q.Ref("indexes/all_Shioors")))).then(response => {
    const shioorRefs = response.data;
    console.log("Shioor refs", shioorRefs);
    console.log(`${shioorRefs.length} shioors found`); // create new query out of Shioor refs. http://bit.ly/2LG3MLg
